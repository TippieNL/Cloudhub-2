...
final class AuditLog {
  ...
  *
  * tools/cleanup-security-events.php does the same and remains the way to force
  * a full sweep -- but it needs cron, and the installations this runs on are
  * phones. Sampled the way LoginRateLimiter prunes login_attempts, so the table
  * is bounded without a scheduled job. Its own try/catch: an audit trail that
  * cannot tidy itself must still record the event.
  */
