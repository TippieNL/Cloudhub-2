...
// yet loses nothing but the Favorites screen.
...
// Creating a share looks for an existing live link by path before issuing a
// token, so without this every Share click scanned the whole table. TEXT needs
// a prefix length, matching the (190) file_metadata already uses.
 ...
 * them -- so they are reported for a human to resolve and the rest continues.
 */
