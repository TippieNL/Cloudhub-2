...
<head>
    ...
    <!-- Installable web app. The manifest is generated by the front controller
         so start_url, scope and the share target carry the real base path. -->
    <link rel="manifest" href="<?= htmlspecialchars($frontController, ENT_QUOTES) ?>manifest.webmanifest">
    <meta name="theme-color" content="#1479c9">
    <meta name="application-name" content="CloudHub">
    <meta name="mobile-web-app-capable" content="yes">
    <!-- iOS ignores the manifest for the home-screen icon and the status bar. -->
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-title" content="CloudHub">
    <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent">
    <link rel="apple-touch-icon" href="<?= htmlspecialchars($assetBase, ENT_QUOTES) ?>/assets/icons/apple-touch-icon.png">
...
<body>
    ...
    <p id="offline-banner" role="status" aria-live="polite" hidden>
        You are offline. Folders you have opened before and files kept for offline use are still available.
    </p>
    <main>
    ...
    <script nonce="<?= htmlspecialchars(\CloudHub\Services\Security::cspNonce(), ENT_QUOTES) ?>">
        ...
        // The service worker caches these, and cannot work out where
        // they live on its own -- /assets or /public/assets depends on
        // where the document root was pointed.
        window.CLOUDHUB_ASSETS = <?= json_encode($assetBase, JSON_UNESCAPED_SLASHES) ?>;
